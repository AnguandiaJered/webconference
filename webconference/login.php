...
<!-- Mirrored from apdash.themetags.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 13:40:26 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--favicon icon-->
    <link rel="icon" href="assets/img/logo-cpn" type="image/jpg" sizes="16x16">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="login-signup-wrap p-5 gray-light-bg rounded shadow">
                        ...
                        <p class="text-center mb-0">Don't have an account? <a href="sign-up.php">Register</a></p>
                    </div>
                </div>
            </div>
