...
<!-- Mirrored from apdash.themetags.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Feb 2021 13:38:43 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="main">
                ...
                <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
                    <div class="col-md-12 col-lg-6">
                        <div class="hero-slider-content text-white py-5">
                            <h1 class="text-white">Suivez votre formation en ligne ici</h1>
                            <p class="lead"><a id="ab" href="#">e-formation.com</a>est une plateforme d'apprentissage en ligne.<br>Ce site est principalement destiné aux formateurs désirants animer une formation en distance et <br> aux étudiants cherchants à assister une téléformation.
                            <br>Alors formateurs ou étudiants ? N'hesitez plus et <a id="ab" href="#"> rejoignez-nous dès maintenant !</a></p>
                    ...
                    <div class="col-md-8 col-sm-8 col-lg-6">
                        <div class="img-wrap">
                            <img src="assets/img/image.jpg" alt="app image" class="img-fluid">
                        </div>
                    </div>
                </div>
                <!--end of row-->
                    ...
                    <div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            <div class="about-content-right">
                                <img id="ima" src="assets/img/image2.jpg" alt="about us" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="position-relative feature-section ptb-100">
            <div class="container">
                <div class="row align-items-center justify-content-between justify-content-sm-center justify-content-md-center">
                    <div class="col-sm-5 col-md-9 col-lg-6 mb-5 mb-md-5 mb-sm-5 mb-lg-0">
                        <div class="download-img">
                            <img id="ima" src="assets/img/image1.jpg" alt="download" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
                        <div class="feature-contents">
                            ...
                            <div class="action-btns mt-4">
                                ...
                                <a href="#" class="btn btn-outline-brand-02">More About Us</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center justify-content-md-center">
                    ...
                    <div class="col-lg-4 col-md-5 d-none d-sm-none d-md-block d-lg-block">
                        <div class="position-relative pb-md-5 py-lg-0">
                            <img alt="Image placeholder" id="ima" src="assets/img/image10.jpg" class="img-center img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="row">
            ...
            <div class="container">
                ...
                <div class="screenshot-wrap">
                    ...
                    <div class="screen-carousel owl-carousel owl-theme dot-indicator">
                        <img id="imag" src="assets/img/image1.jpg" class="img-fluid" alt="screenshots" />
                        <img id="imag" src="assets/img/image5.jpg" class="img-fluid" alt="screenshots" />
                        <img id="imag" src="assets/img/image6.jpg" class="img-fluid" alt="screenshots" />
                        <img id="imag" src="assets/img/image7.jpg" class="img-fluid" alt="screenshots" />
                        <img id="imag" src="assets/img/image8.jpg" class="img-fluid" alt="screenshots" />
                        <img id="imag" src="assets/img/image9.jpg" class="img-fluid" alt="screenshots" />
                    </div>
                </div>
        ...
        <section id="faq" class="ptb-100 ">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-6 mb-5 mb-md-5 mb-sm-5 mb-lg-0">
                        <div class="img-wrap">
                            <img id="ima" src="assets/img/image4.jpg" alt="download" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-6">
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h3>ASETIG</h3>
                <p>L'ASETIG est encore reconnue comme l'association congolaise qui a fait bouger, à ses débuts, le campus par ces activités.</p>
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div>
                    ...
                    <p>Unigom<br>Goma Ville, NY 512</p>
                </div>

                <div>
                    <i class="ion-ios-email-outline"></i>
                    <p><a href="mailto:anguandiatsandijered03@gmail.com">infosasetig03@gmail.com</a></p>
                </div>

                <div>
                    <i class="ion-ios-telephone-outline"></i>
                    <p>+243 825 053 403 <br>+243 978 451 020</p>
                </div>
            ...
            <div class="col-lg-5 col-md-8">
                ...
                <form action="message.php" method="POST" role="form" class="contactForm" autocomplete="off">
                    <div class="form-row">
                    ...
                    <div class="form-group col-lg-6">
                        <input type="email" class="form-control" name="mail" id="email" placeholder="Votre mail" data-rule="email" data-msg="Please enter a valid email" />
                        <div class="validation"></div>
                    </div>
                    </div>
                    ...
                    <div class="text-center"><button type="submit" title="Send Message">Envoyer Message</button></div>
                </form>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-7">
                    <div class="copyright-wrap small-text">
                        <p class="mb-0">&copy;Copyright Congo Peace Network, All rights reserved</p>
                    </div>
                </div>
